  ...
  return (
    <footer className="flex flex-col items-center justify-center w-full mt-18 py-10 bg-gradient-to-b from-emerald-100/10 to-emerald-200">
        <div className="flex items-center ">
            <img className="h-25 hover:bg-emerald-100/40 p-2 rounded-2xl cursor-pointer" src={assets.logo} alt="logo" />
        </div>

        {/* Copyright */}
        <p className="mt-4 text-center text-gray-700"> Copyright © 2025{" "}
            <a href="#" className="underline hover:text-emerald-900"> {import.meta.env.VITE_BRAND_NAME} </a>
            . All rights reserved.
        </p>
